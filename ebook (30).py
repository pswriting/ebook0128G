...
/* 버튼 - 럭셔리 골드 + 고급 효과 */
.stButton > button {
    background: linear-gradient(135deg, rgba(201,162,75,0.1) 0%, transparent 50%, rgba(201,162,75,0.1) 100%) !important;
    ...
    position: relative;
    overflow: hidden;
    box-shadow: 0 2px 10px rgba(201,162,75,0.1);
}
...
.stButton > button:hover {
    ...
    box-shadow: 0 8px 30px rgba(201,162,75,0.4), 0 0 20px rgba(201,162,75,0.2);
...
/* 섹션 타이틀 - 화려하게 */
.section-title-box {
    background: linear-gradient(135deg, rgba(201,162,75,0.15) 0%, rgba(201,162,75,0.1) 50%, rgba(201,162,75,0.15) 100%);
    border: 0.5px solid rgba(201,162,75,0.35);
    border-radius: 16px;
    padding: 30px 40px;
    margin-bottom: 35px;
    text-align: center;
