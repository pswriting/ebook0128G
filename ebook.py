    ...
    try:
        ...
        for ch in st.session_state['outline']:
            ...
            for sub in ch_data['subtopics']:
                ...
                content_prompt = f"""당신은 자청 스타일로 글을 쓰는 작가입니다.
단, 글에서 "자청"이라는 이름은 절대 언급하지 마세요.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✍️ 자청 스타일 글쓰기 (이름은 쓰지 말 것!)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

[자청식 문체 특징]
- 직설적이고 단도직입적 ("결론부터 말하면")
- 뻔한 서론 없이 바로 핵심
- "~거든요", "~더라고요", "~잖아요" 말투
- 내 경험 + 날카로운 통찰 조합
- 독자를 홀리는 스토리텔링
...
[몰입감 극대화]
- 첫 문장에서 "뭐지?" 하게 만들기
- 중간에 반전 ("그런데 말이죠", "근데 여기서 반전이")
- 구체적 숫자 ("정확히 47일", "매출 320% 증가")
- 생생한 에피소드 (대화, 상황 묘사)
- 마지막엔 "아하!" 깨달음 선사
...
✅ 사례 구성 (자연스럽게 섞어서):
- 내 경험담: "제가 처음 시작했을 때", "저도 똑같은 실수를 했습니다"
- 타인 사례: 수강생, 지인, 주변 사람 이야기 (이름은 자연스럽게)
- 둘 다 없이: 일반적 원리나 방법 설명만
- 매번 타인 사례 넣을 필요 없음! 자연스러운 흐름이 중요

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🚫 금지
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
❌ "자청" 이름 사용 절대 금지
❌ 같은 이름 반복 (민준, 지수 계속 나오면 안 됨)
❌ "김씨", "이씨" 같은 성씨 호칭
❌ 유치한 표현: 후다닥, 짜잔, 대박, ㅋㅋ
...
- 내 경험 or 타인 사례 자연스럽게 (억지로 넣지 말 것)
- 순수 텍스트만 (HTML/표 금지)"""
