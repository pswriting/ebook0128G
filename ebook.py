...
def build_cover_svg(template, title, subtitle, author):
    ...
    if template == "noir_gold":
        ...
        body = (
            ...
            + f'<line x1="704" y1="{top - 150}" x2="896" y2="{top - 150}" stroke="#C9A24B" stroke-width="2.5"/>'
            + t
        ...
        body = (
            ...
            '<path d="M 200 2010 L 480 1900 L 740 1945 L 1030 1780 L 1400 1660" fill="none" stroke="#C9A24B" stroke-width="3.5" opacity="0.8"/>'
