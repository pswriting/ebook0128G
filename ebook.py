...
def build_cover_svg(template, title, subtitle, author):
    ...
    if template == "noir_gold":
        ...
        body = (
            ...
            + eyebrow(800, 350, "CLASSIC INSIGHT SERIES", '#8A7A55', sans, 30)
        ...
        body = (
            ...
            '<text x="1450" y="620" text-anchor="end" font-family="Georgia,serif" font-size="700" font-weight="700" fill="#16553F" opacity="0.85">”</text>'
        ...
        body = (
            ...
            f'<text x="800" y="1040" text-anchor="middle" font-family="{gmarket}" font-size="{nfs}" font-weight="700" fill="none" stroke="#D8483A" stroke-width="5" opacity="0.55">{bignum}</text>'
            f'<text x="800" y="1040" text-anchor="middle" font-family="{gmarket}" font-size="{nfs}" font-weight="700" fill="#D8483A" opacity="0.08">{bignum}</text>'
        ...
        body = (
            ...
            '<circle cx="1300" cy="400" r="320" fill="none" stroke="#FFFFFF" stroke-width="1.5" opacity="0.3"/>'
            '<circle cx="1300" cy="400" r="240" fill="none" stroke="#FFFFFF" stroke-width="1" opacity="0.22"/>'
            '<circle cx="280" cy="1900" r="430" fill="none" stroke="#FFFFFF" stroke-width="1" opacity="0.18"/>'
        ...
        body = (
            ...
            '<circle cx="800" cy="600" r="280" fill="#F2C9A8" opacity="0.8"/>'
            '<circle cx="985" cy="490" r="95" fill="#E8A87C" opacity="0.55"/>'
            '<path d="M 530 760 Q 800 870 1070 760" stroke="#C8A287" stroke-width="2" fill="none" opacity="0.7"/>'
        ...
        body = (
            ...
            '<line x1="0" y1="1810" x2="1600" y2="1810" stroke="#DDDAD2" stroke-width="1"/>'
            '<line x1="0" y1="1880" x2="1600" y2="1880" stroke="#DDDAD2" stroke-width="1"/>'
        ...
        body = (
            ...
            + eyebrow(800, 360, "WAKE UP CALL", '#777777', sans, 32, 12)
            + t
