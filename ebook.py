...
- 취재 말투 꼬리 명사 금지: "~한 현장", "~의 민낯", "~의 실체", "~의 풍경", "~의 기록"으로 끝나는 줄 금지 — 뉴스 리포트 말투라 어색하다.
...
취재 꼬리 명사: "~한 현장" / "~의 민낯" / "~의 실체" / "~의 풍경" / "~의 기록" — 뉴스 리포트 말투, 꼬리를 떼고 완결문으로
