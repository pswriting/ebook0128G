...
⑳ 명사형 종결·단어 반복: "~멈춤/~공개" 같은 명사형 종결 → 완결문으로 ("석 달째 조회수가 한 자릿수였다"),
...
━━━━━━━━━━━━━━━━━━━━━━━━━━
2. 한 줄 작법 — 실제 베스트셀러 패턴 12개 (이 패턴들로만 써라, 각 1~3회)
━━━━━━━━━━━━━━━━━━━━━━━━━━
...
- 🚫 낯선 서수 + 실적 숫자 조합 금지 (첫 줄만이 아니라 25줄 전체): ❌ "세 번째 책을 올리고 판매 0건에 멈췄다"
  — 맥락 없는 서수('세 번째')와 '0건/0원/0명' 나열은 번역투라 어색하고 독자가 이입할 틈이 없다.
  서수를 버리고 독자도 겪는 보편적 장면으로: 실패는 '비어 있는 판매 화면', '들어오지 않는 알림'처럼 장면으로 보여줘라.
...
- 컨셉명은 소제목에만 3회 (각 슬롯에 ⑧⑨ 패턴 사용 가능 — "'○○○'만 알면 인생이 바뀐다" / "'○○○'가 삶을 바꾸는 이유" 식):
  ...
  🚨 컨셉명이 든 줄은 목차에서 가장 짧고 단순해야 한다 — 컨셉명 앞에 관형절 금지.
     ...
     → 컨셉명을 빼고 장면으로: ✅ "신간 없이도 매출이 유지되기 시작했다" / 컨셉명을 쓰려면 단순하게: ✅ "'○○'를 처음 적용한 날 생긴 일"
