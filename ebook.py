...
체크 14. 25줄 전부가 '한 줄 주장' 하나를 전개하는가? 컨셉이 N요소 공식이면 PART 3~4에 요소당 '요소→결과' 줄이 있어서, 독자가 공식의 축들이 각각 무슨 일을 하는지 짐작할 수 있는가?
