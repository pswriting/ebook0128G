...
- 챕터 제목: 13~18자 선언형 또는 장면형. "~하게 된다/~할 수 있다" 같은 결과 설명형 금지.
...
- 컨셉명은 소제목에만 3회: PART 1 마지막("결국 모든 답은 '컨셉명' 안에 있었다" 식 도입), PART 3 또는 4에 1회(작동 신호), PART 5 마지막(익힌 사람들의 미래). 컨셉명 글자 수 단정 표현("세 글자" 등) 금지.

━━━━━━━━━━━━━━━━━━━━━━━━━━
4. 온도 기준 — 모범 목차 (톤만 모방, 문장 구조·단어·숫자 복제 금지)
━━━━━━━━━━━━━━━━━━━━━━━━━━
...
출력 전 마지막 점검: ① 챕터 5개만 이어 읽어도 줄거리가 보이는가 ② 존댓말 0건인가 ③ 수단이 보이는 줄 8개 이상인가 ④ 사물 비유 테마가 없는가 ⑤ 모든 줄이 "뭔데? 왜?"를 일으키는가. 점검 결과는 출력하지 마라."""
